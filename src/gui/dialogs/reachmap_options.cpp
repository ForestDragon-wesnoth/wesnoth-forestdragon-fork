...
{
	setup_orb_group("unmoved2", show_unmoved_, prefs::get().unmoved_color());
...
void reachmap_options::setup_orb_toggle(const std::string& base_id, bool& shown)
{
	...
	connect_signal_mouse_left_click(toggle, std::bind(&reachmap_options::toggle_orb_callback, this, std::ref(shown)));
}

void reachmap_options::setup_orb_group(const std::string& base_id, bool& shown, const std::string& initial)
{
...
void reachmap_options::setup_orb_group_two_color(const std::string& base_id, bool& shown, bool& two_color, const std::string& initial)
{
	...
	connect_signal_mouse_left_click(toggle, std::bind(&reachmap_options::toggle_orb_callback, this, std::ref(two_color)));
}

void reachmap_options::reset_orb_toggle(const std::string& base_id, bool shown)
{
	const std::string prefix = get_orb_widget_prefix(base_id);
...
void reachmap_options::reset_orb_group(const std::string& base_id, bool shown, const std::string& initial)
{
	reset_orb_toggle(base_id, shown);
	groups_[base_id].set_member_states(initial);
}

void reachmap_options::reset_orb_group_two_color(const std::string& base_id, bool shown, bool two_color, const std::string& initial)
{
...
void reachmap_options::toggle_orb_callback(bool& storage)
{
...
void reachmap_options::reset_orb_callback()
{
